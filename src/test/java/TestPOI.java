...
public class TestPOI {
    ...
    //    );
    //
    //    String name = "E:\\"+LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMddHHmmss"))+".xlsx";
    ...
    //@Test
    //public void test2() throws IllegalAccessException, IntrospectionException, InvocationTargetException, IOException, InstantiationException, ParseException, InvalidFormatException {
    //    //导出参数配置
    //    List<Col> cols = Lists.newArrayList(
    //            new Col("姓名","name"),
    //            new Col("年龄","age"),
    ...
    //    );
    //    List<Person> list = (List<Person>) ExcelUtils.readExcel("E:\\20190301135920.xlsx", TableParam.of(cols), Person.class);
    //
